...
class Kohana_Database_MySQLi_Result extends Database_Result {
	...
	public function __construct(mysqli_result $result, $sql, $as_object = FALSE, array $params = NULL)
	{
	...
	public function current()
	{
		...
		elseif (is_string($this->_as_object) && null !== $this->_as_object)
		{
			// Return an object of given class name
			return $this->_result->fetch_object($this->_as_object, is_array($this->_object_params) ? $this->_object_params : array());
		}
		else
		{
